...
class Dispatch:
    ...
    def _args(self, argv):
        ...
        try:
            ...
            print './sync_folders.py -s <sourceFolder> -d <destinationFolder>'
            sys.exit(2)
        for opt, arg in opts:
            if opt == '-h':
                print 'sync_folders.py -s <sourceFolder> -d <destinationFolder>'
        ...
        if sourceFolder and destinationFolder:
            ...
            print 'Pass source and destination folder path as parameters, example below:'
            print './sync_folders.py -s <sourceFolder> -d <destinationFolder>'
            sys.exit()        
...
if __name__ == "__main__":
    ...
    source_folder, destination_folder = my_dispatch._args(sys.argv[1:])
    node1 = Node(source_folder, 'node1')
    node2 = Node(destination_folder, 'node2')
